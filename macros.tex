...
\newcommand*{\kw}[1]{{\text{\ttt{#1}}}} % used to be \tt but may be obsolete?

\newcommand*{\twoPrime}{{\prime\mkern-2.6mu\prime\mkern-2.2mu}}
\newcommand*{\threePrime}{{\prime\mkern-2mu\prime\mkern-2mu\prime\mkern-2mu}}
...
\newcommand*{\bigdisjunion}{\biguplus}
...
\newcommand*{\apprefTwo}[2]{Appendices~\ref{app:#1} and \ref{app:#2}}
\newcommand*{\conjref}[1]{Conjecture~\ref{conj:#1}}
\newcommand*{\corref}[1]{Corollary~\ref{cor:#1}}
\newcommand*{\defref}[1]{Definition~\ref{def:#1}}
\newcommand*{\defrefShort}[1]{Def.~\ref{def:#1}}
\newcommand*{\Defref}[1]{Definition~\ref{def:#1} (\nameref{def:#1})}
...
\newcommand*{\figrefShort}[1]{Fig.~\ref{fig:#1}}
...
\newenvironment{tblsqitemize}
    {\begin{itemize}[label=$\sqbullet$,after=\vspace*{-\baselineskip}]}
    {\end{itemize}}
